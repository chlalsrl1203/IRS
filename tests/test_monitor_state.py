...
def test_real_repo_today_has_no_unreviewed_backlog():
    ...
    assert result["n_ledgers"] == 71  # 2026-09-01/04: CROX·SIGI·OKTA·MEDP·RYAN·FIX·NBIX·NXT·PATH·PCTY·EXEL·PINS·ROKU·HLNE·FIVE·TW·RLI·DOCU·CINF·TENB·SKYW·RMBS·BYD·CRM·DECK·QCOM·EAT·ADBE·MMS·CHWY 정식분석 추가 + 2026-09-04 포트폴리오 재검토로 DLO·NOW 신규(34->66) + 2026-09-06 CAH(67) + 2026-09-08 HQY(68) + 2026-09-09 URBN(69)·REGN(70)·LFUS(71)
