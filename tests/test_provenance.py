...
KNOWN_PROVENANCE_RECORDED_LEDGERS = {"CROX", "SIGI", "OKTA", "MEDP", "RYAN", "FIX", "NBIX", "NXT", "PATH", "PCTY", "EXEL", "PINS", "ROKU", "HLNE", "FIVE", "TW", "RLI", "DOCU", "CINF", "TENB", "SKYW", "RMBS"}  # 2026-09-01/04, 분석 시점에 확보
