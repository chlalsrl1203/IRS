...
KNOWN_POST_SNAPSHOT_LEDGERS = {"CROX", "SIGI", "OKTA", "MEDP", "RYAN", "FIX", "NBIX", "NXT", "PATH", "PCTY", "EXEL", "PINS", "ROKU", "HLNE", "FIVE", "TW", "RLI", "DOCU", "CINF", "TENB", "SKYW", "RMBS", "BYD"}  # 2026-09-01/04, 스냅샷(2026-08-21) 이후 신규
